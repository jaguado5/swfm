...
//
// clase: QuinClasifJornadaServlet
//
//*****************************************************************
...
/*************************************************************************/
//                         Class QuinClasifJornadaServlet
/*************************************************************************/
public class QuinielaClasifJornadaServlet extends HttpServlet {

    private static final long serialVersionUID = 1L;

    private transient static final Log log=LogFactory.getLog(QuinielaClasifJornadaServlet.class);
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        log.info("(QuinClasifJornadaServlet/doPost) jornada:" + jornadaStr);
